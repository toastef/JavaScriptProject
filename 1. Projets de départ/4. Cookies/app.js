...
// changement du message du required si le champ reste vide
...
function handleForm(e) {
    ...
    const newCookie = {};
     inputs.forEach(input => {
         // va permettre de récupérer l'attribut du name spécifique en html ==> "name" et "value"
        const nameAttribute = input.getAttribute("name")
        newCookie[nameAttribute] = input.value;
    })

    // expire dans une semaine date +7 jour * 24 heures * 60 minutes * 60 sec * 1000 ms
